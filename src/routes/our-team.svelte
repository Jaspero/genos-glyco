...
<svelte:head>
  ...
  <meta
    name="description"
    content="Experienced team of scientists in Genos have cumulatively over 150 years of experience in glycan analysis."
  />
</svelte:head>
...
<section class="bg-l-secondary team p-y-l">
  <div class="grid p-b-m">
    ...
    {#each members as member, i}
      <div
        class="col-3 col-m-4 col-s-6 col-xs-12 p-a-s ta-center"
